...
# 1. Filtramos solo los productos de la categoría FRUTAS Y VERDURAS y sin NA en Cantidad
frutas_verduras <- datos_integrados %>%
  filter(Producto == "FRUTAS Y VERDURAS", !is.na(Cantidad))

# 2. Agrupamos por producto y sumamos los kilos vendidos
top_frutas_verduras <- frutas_verduras %>%
  group_by(Producto) %>%
